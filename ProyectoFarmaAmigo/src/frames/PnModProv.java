 ...
 */
public class PnModProv extends javax.swing.JPanel
{
    ...
    {
        initComponents();
        VtnPrincipal.disablePaste(direccion, cCorreo);
        msj.setVisible(false);
        llenadoCombo(cmFarmaciaSuc, "SELECT p.nombreProv FROM proveedor p ORDER BY p.nombreProv;");
    }
    ...
    private void initComponents()
    {
        ...
        jLabel14.setText("Modifica Proveedor");
        ...
        btnAgregar.setText("Modifiaca Proveedor");
        ...
        AgregarSucursales.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 200, 180, 30));
        ...
        RegresarINLayout.setHorizontalGroup(
            ...
            .addGroup(RegresarINLayout.createSequentialGroup()
                .addComponent(RegresarINtxt, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        AgregarSucursales.add(RegresarIN, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 260, 180, 30));
        ...
        AgregarSucursales.add(direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 230, 340, 30));
        ...
        AgregarSucursales.add(cCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 310, 340, 30));
    ...
    {//GEN-HEADEREND:event_btnAgregarActionPerformed
        if (cmFarmaciaSuc.isEnabled())
        {
            if (VtnPrincipal.vComponentes(direccion, cCorreo))
            {
                msj.setVisible(true);
                msj.setText("<html>" + VtnPrincipal.componentes(direccion, cCorreo) + "<html>");
            } else
            {

                Crud.modificacion("UPDATE proveedor p SET p.direccion = '" + direccion.getText() + "', p.correo = '" + cCorreo.getText()
                        + "' WHERE p.nombreProv = '" + String.valueOf(cmFarmaciaSuc.getSelectedItem()) + "';");
                msj.setVisible(false);
                CtrlInterfaz.limpia(direccion, cCorreo);
                JOptionPane.showMessageDialog(null, "Proveedor modificada con exito", "Altas", JOptionPane.PLAIN_MESSAGE, icono("/imagenes/comprobado.png", 50, 50));
    ...
    {//GEN-HEADEREND:event_direccionKeyTyped
        Validaciones.validaAlfabeticos(evt, 20, direccion.getText());
        if (evt.getKeyChar() == '.')
        {
    ...
    {//GEN-HEADEREND:event_cCorreoKeyTyped
        Validaciones.validaAlfanumerico(evt, 30, cCorreo.getText());
    ...
    {//GEN-HEADEREND:event_cCorreoActionPerformed
        // TODO add your handling code here:
