...
public class Lecturas
{
     ...
     */
    public static int entero(JFrame jf, boolean b)
    {
        do
        {
            try
            ...
            {
                Mensaje.error(jf, "Error...se esperaba un entero, vuelva a intentarlo, o verifique el error " + ex.toString());
            }
        } while (b);
        return 0;
    }
    ...
    public static double doble(JFrame jf, boolean b)
    {
        do
        {
            ...
            {
                Mensaje.error(jf, "Error...se esperaba un valor flotante, vuelva a intentarlo o verifique el error " + ex.toString());
            }
        } while (b);
        return 0;
    }
    ...
    public static String cadena(JFrame jf, boolean b)
    {
        ...
        do
        {
            try
            {
                ...
                if (s.trim().equals(""))
                {
                    Mensaje.error(jf, "El valor esperado no puede ser vacio o nulo");
                }else
                {
                    b = false;
                }
     ...
     * proporcionado
     */
    public static int entero(JDialog jf)
    {
        try
        {
            return Integer.parseInt(br.readLine());
     ...
     * @return el entero proporcionado
     */
    public static int entero(JDialog jf, boolean b)
    {
        do
        {
            try
     ...
     * proporcionado
     */
    public static double doble(JDialog jf)
    {
        try
        {
            return Double.parseDouble(br.readLine());
     ...
     * @return el doble proporcionado
     */
    public static double doble(JDialog jf, boolean b)
    {
        do
        {
            try
     ...
     * @return el caracter leido o ' ' en caso de haberse presentado un error
     */
    public static char caracter(JDialog jf)
    {
        char c = ' ';
        try
        {
     ...
     * @return cadena leida o si hubo un error retorna "";
     */
    public static String cadena(JDialog jf)
    {
        try
        {
            return br.readLine();
